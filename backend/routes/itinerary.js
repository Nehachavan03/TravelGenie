...
const query = `     INSERT INTO itineraries (user_id, start_date, end_date, budget, city_id)
    VALUES (?, ?, ?, ?, ?)
  `;
...
const query = `     INSERT INTO itinerary_details (itinerary_id, day_no, place_id)
    VALUES (?, ?, ?)
  `;
...
const query = `     SELECT i.itinerary_id, i.start_date, i.end_date, i.budget,
           c.name AS city
    FROM itineraries i
